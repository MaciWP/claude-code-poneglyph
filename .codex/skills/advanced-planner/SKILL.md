...
description: Advanced planning with execution roadmap, dependency graph, and parallelization. Use when the user asks for a detailed plan, roadmap, or complex multi-step orchestration.
---
