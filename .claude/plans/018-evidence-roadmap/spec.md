...
| W3 | Measured context degradation (RULER, NoLiMa, context-rot reports, LongBench v2); practical utilization thresholds; compaction vs note-taking vs subagent-compression comparisons; **code-graph context layer** (graphify + category — added at gate-2→3 REFINE, seed scouted 2026-06-10) | Lead context policy (when to delegate reads, when to compact) + graphify adopt/watchlist/discard verdict |
