...
| `security-audit` | Different scope: `security-audit` audits existing code; `decision-stress-test` includes Security as one perspective among 11 when stakes are High |
