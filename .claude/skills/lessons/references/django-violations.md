# Django violation examples (binora-backend)

Migrated 2026-08-06 from `django-review-lessons/examples/common-violations.md` — long-form wrong/right pairs.

## Common Violations - Real Examples

Real-world examples of violations from Binora Backend, with ❌ WRONG and ✅ CORRECT patterns.
...
# Actual API response
{
    "url": "http://api.binora.com/api/assets/123/",
    "id": 123,
    ...
    "parent": "http://api.binora.com/api/assets/100/",
    "status": "Active",
        ...
        200:
          ...
          content:
            application/json:
              ...
              example:
                count: 150
                next: "http://api.binora.com/api/assets/?page=2"
                previous: null
                results:
                  - url: "http://api.binora.com/api/assets/123/"
                    id: 123
